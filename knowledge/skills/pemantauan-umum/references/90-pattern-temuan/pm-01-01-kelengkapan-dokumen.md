<!-- ============================================================
     ...
     Sumber  : knowledge/wiki/temuan-patterns/pemantauan-umum/pm-01-01-kelengkapan-dokumen.md
...
# PM-01: Kelengkapan Dokumen Pendukung Belum Memadai

## Pattern Kondisi
Dokumen pendukung penugasan Pemantauan tidak lengkap untuk membentuk keyakinan/pendapat memadai. Indikator umum:
...
## Catatan
Pattern starter — disusun saat skill `pemantauan-umum` belum punya pattern historis. Akan di-deprecate setelah ≥5 pattern historis dari penugasan riil terbentuk.
