<!-- ============================================================
     ...
     Sumber  : knowledge/wiki/temuan-patterns/reviu-umum/rv-01-01-kelengkapan-dokumen.md
...
# RV-01: Kelengkapan Dokumen Pendukung Belum Memadai

## Pattern Kondisi
Dokumen pendukung penugasan Reviu tidak lengkap untuk membentuk keyakinan/pendapat memadai. Indikator umum:
...
## Catatan
Pattern starter — disusun saat skill `reviu-umum` belum punya pattern historis. Akan di-deprecate setelah ≥5 pattern historis dari penugasan riil terbentuk.
