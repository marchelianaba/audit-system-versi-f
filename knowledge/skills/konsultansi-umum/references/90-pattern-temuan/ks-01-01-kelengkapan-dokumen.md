<!-- ============================================================
     ...
     Sumber  : knowledge/wiki/temuan-patterns/konsultansi-umum/ks-01-01-kelengkapan-dokumen.md
...
# KS-01: Kelengkapan Dokumen Pendukung Belum Memadai

## Pattern Kondisi
Dokumen pendukung penugasan Konsultansi tidak lengkap untuk membentuk keyakinan/pendapat memadai. Indikator umum:
...
## Catatan
Pattern starter — disusun saat skill `konsultansi-umum` belum punya pattern historis. Akan di-deprecate setelah ≥5 pattern historis dari penugasan riil terbentuk.
