<!-- ============================================================
     ...
     Sumber  : knowledge/wiki/temuan-patterns/audit-umum/au-01-01-kelengkapan-dokumen.md
...
# AU-01: Kelengkapan Dokumen Pendukung Belum Memadai

## Pattern Kondisi
Dokumen pendukung penugasan Audit tidak lengkap untuk membentuk keyakinan/pendapat memadai. Indikator umum:
...
## Catatan
Pattern starter — disusun saat skill `audit-umum` belum punya pattern historis. Akan di-deprecate setelah ≥5 pattern historis dari penugasan riil terbentuk.
