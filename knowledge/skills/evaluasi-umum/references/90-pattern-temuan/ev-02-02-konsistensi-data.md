<!-- ============================================================
     ...
     Sumber  : knowledge/wiki/temuan-patterns/evaluasi-umum/ev-02-02-konsistensi-data.md
...
# EV-02: Inkonsistensi Data antar Dokumen Pendukung

## Pattern Kondisi
Data antar dokumen objek pengawasan Evaluasi tidak konsisten — angka, tanggal, nama pihak, atau referensi pasal berbeda di dokumen yg seharusnya saling rujuk. Indikator umum:
